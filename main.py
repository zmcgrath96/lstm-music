...
def main(args):
	if '-t' in args[0]:
		...
		lstm.train(piano_in, piano_out, 'piano_lstm', it=10, batch=64)
		...
		# train 
		lstm = musicLSTM(in_shape, out_shape)
		lstm.train(bass_in, bass_out, 'bass_lstm', it=10, batch=64)
		...
		# train 
		lstm = musicLSTM(in_shape, out_shape)
		lstm.train(bass_in, bass_out, 'sax_lstm', it=10, batch=64)
